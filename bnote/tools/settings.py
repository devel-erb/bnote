    ...
    def __init__(self):
        self.DEFAULT_VALUES = {'system': {'braille_type': 'dot-8',
                               ...
                               'music_bxml': {'edit_mode' : 'read',
                                              ...
                                              'lyrics' : 'no',
                                              'karaoke' : True},
                               'speech': {'volume_headphone': 40,
                                          'volume_hp': 55,
                                          'speed': 110,
                                          'language': "fr_FR",
                                          'synthesis': 'cerence',
                                          'voice': 'audrey'},
                               'radio': {'volume_headphone': 40,
                                         'volume_hp': 55},
                               'bluetooth': {'bnote_visible': True,
                                             'bnote_name': "",
                                             'auto_switch': [],
                                             'bt_simul_esys': True},
                               'agenda': {'default_presentation':'standard',
                                          'remember': 'no'},
                               'braille_learning': {
                                                    'use_vocal': "auto",
                                                    'keep_spaces': False,
        ...
        self.VALID_VALUES = {'system': {'braille_type': ('dot-8', 'grade1', 'grade2'),
                             ...
                             'editor': {'braille_type': ('dot-8', 'grade1', 'grade2'),
                             ...
                             'math': {'angle': ('degree', 'radian'),
                                      'fraction': (True, False),
                                      'precision': range(0, 9),
                                      'format': ('scientific', 'normal')},
                             'music_xml': {'edit_mode' : ('expert', 'read', 'edit', 'listen'),
                             ...
                             'music_bxml': {'edit_mode' : ('expert', 'read', 'edit', 'listen'),
                                            'braille_type': ('dot-8', 'grade1'),
                                            'notes_dots': ('8_dots','6_dots', '6_dots_with_group'),
                                            'ascending_chords': (False, True),
                                            'fingering': (False, True),
