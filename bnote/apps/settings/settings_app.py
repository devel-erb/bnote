...
class SettingsApp(BnoteApp):
    ...
    def __create_action_and_action_param(self):
        ...
        return {
            ...
            ('bluetooth', 'power'): {'action': self.__dialog_set_bluetooth_power, 'action_param': {'section': 'bluetooth', 'key': 'power'}},
            ...
            ('wifi', 'power'): {'action': self.__dialog_set_wifi_power, 'action_param': {'section': 'wifi', 'key': 'power'}},
            ('wifi', 'connected_to'): {'action': None, 'action_param': {'section': 'wifi', 'key': 'connected_to'}},
            ...
            ('system', 'auto_sync_date'): {'action': self.__dialog_set_settings, 'action_param': {"section": 'system', "key": 'auto_sync_date'}},
            ('system', 'spaces_in_label'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'spaces_in_label'}},
            ('system', 'shortcuts_visible'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'shortcuts_visible'}},
            ('system', 'developer'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'developer'}},
            ('system', 'app_explorer'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'app_explorer'}},
            ('system', 'app_settings'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'app_settings'}},
            ('system', 'app_agenda'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'app_agenda'}},
            ('system', 'app_radio'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'app_radio'}},
            ('system', 'app_wikipedia'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'app_wikipedia'}},
            ('system', 'app_mp3'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'app_mp3'}},
            ('system', 'app_timer'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'app_timer'}},
            ('system', 'app_translator'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'app_translator'}},
            ('system', 'app_write_word'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'app_write_word'}},
            ('system', 'app_operation'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'app_operation'}},
            ('system', 'app_mines'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'app_mines'}},
            ('system', 'app_mastermind'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'system', 'key': 'app_mastermind'}},
            ('explorer', 'empty_bluetooth_shutdown'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'explorer', 'key': 'empty_bluetooth_shutdown'}},
            ('explorer', 'empty_trash_shutdown'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'explorer', 'key': 'empty_trash_shutdown'}},
            ('explorer', 'number_recent_files'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'explorer', 'key': 'number_recent_files'}},
            ...
            ('music_xml', 'braille_type'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'music_xml', 'key': 'braille_type'}},
            ...
            ('music_bxml', 'braille_type'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'music_bxml', 'key': 'braille_type'}},
            ...
            ('agenda', 'remember'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'agenda', 'key': 'remember'}},
            ('braille_learning', 'use_vocal'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'braille_learning', 'key': 'use_vocal'}},
            ('braille_learning', 'keep_spaces'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'braille_learning', 'key': 'keep_spaces'}},
            ('braille_learning', 'write_all'): {'action': self.__dialog_set_settings, 'action_param': {'section': 'braille_learning', 'key': 'write_all'}},
    ...
    def __create_settings_app_music_xml_menu(self):
        return ui.UiMenuBar(name=_("&musicxml"),
                         menu_item_list=[
                             ui.UiMenuItem(name=_("&edit and play mode"), **self.__action_and_action_param[('music_xml', 'edit_mode')]),
                             ui.UiMenuItem(name=_("braille &type"), **self.__action_and_action_param[('music_xml', 'braille_type')]),
                             ui.UiMenuItem(name=_("notes d&ots"), **self.__action_and_action_param[('music_xml', 'notes_dots')]),
                             ui.UiMenuItem(name=_("&ascending chords"), **self.__action_and_action_param[('music_xml', 'ascending_chords')]),
                             ui.UiMenuItem(name=_("&fingering"), **self.__action_and_action_param[('music_xml', 'fingering')]),
                             ui.UiMenuItem(name=_("&clef"), **self.__action_and_action_param[('music_xml', 'clef')]),
                             ui.UiMenuItem(name=_("&parts"), **self.__action_and_action_param[('music_xml', 'parts')]),
                             ui.UiMenuItem(name=_("&measure b123"), **self.__action_and_action_param[('music_xml', 'measure_b123')]),
                             ui.UiMenuItem(name=_("measure &number"), **self.__action_and_action_param[('music_xml', 'measure_number')]),
                             ui.UiMenuItem(name=_("measure &every"), **self.__action_and_action_param[('music_xml', 'measure_every')]),
                             ui.UiMenuItem(name=_("&view"), **self.__action_and_action_param[('music_xml', 'view')]),
                             ui.UiMenuItem(name=_("&section"), **self.__action_and_action_param[('music_xml', 'section')]),
                             ui.UiMenuItem(name=_("measures per sec&tion"), **self.__action_and_action_param[('music_xml', 'measures_per_section')]),
                             ui.UiMenuItem(name=_("&words"), **self.__action_and_action_param[('music_xml', 'words')]),
                             ui.UiMenuItem(name=_("cre&dit words"), **self.__action_and_action_param[('music_xml', 'credit_words')]),
                             ui.UiMenuItem(name=_("&lyrics"), **self.__action_and_action_param[('music_xml', 'lyrics')]),
                         ])

    def __create_settings_app_music_bxml_menu(self):
        return ui.UiMenuBar(name=_("&bxml"),
                         menu_item_list=[
                             ui.UiMenuItem(name=_("&edit and play mode"), **self.__action_and_action_param[('music_bxml', 'edit_mode')]),
                             ui.UiMenuItem(name=_("braille &type"), **self.__action_and_action_param[('music_bxml', 'braille_type')]),
                             ui.UiMenuItem(name=_("notes d&ots"), **self.__action_and_action_param[('music_bxml', 'notes_dots')]),
                             ui.UiMenuItem(name=_("&ascending chords"), **self.__action_and_action_param[('music_bxml', 'ascending_chords')]),
                             ui.UiMenuItem(name=_("&fingering"), **self.__action_and_action_param[('music_bxml', 'fingering')]),
                             ui.UiMenuItem(name=_("&clef"), **self.__action_and_action_param[('music_bxml', 'clef')]),
                             ui.UiMenuItem(name=_("&parts"), **self.__action_and_action_param[('music_bxml', 'parts')]),
                             ui.UiMenuItem(name=_("&measure b123"), **self.__action_and_action_param[('music_bxml', 'measure_b123')]),
                             ui.UiMenuItem(name=_("measure &number"), **self.__action_and_action_param[('music_bxml', 'measure_number')]),
                             ui.UiMenuItem(name=_("measure &every"), **self.__action_and_action_param[('music_bxml', 'measure_every')]),
                             ui.UiMenuItem(name=_("&view"), **self.__action_and_action_param[('music_bxml', 'view')]),
                             ui.UiMenuItem(name=_("&section"), **self.__action_and_action_param[('music_bxml', 'section')]),
                             ui.UiMenuItem(name=_("measures per sec&tion"), **self.__action_and_action_param[('music_bxml', 'measures_per_section')]),
                             ui.UiMenuItem(name=_("&words"), **self.__action_and_action_param[('music_bxml', 'words')]),
                             ui.UiMenuItem(name=_("cre&dit words"), **self.__action_and_action_param[('music_bxml', 'credit_words')]),
                             ui.UiMenuItem(name=_("&lyrics"), **self.__action_and_action_param[('music_bxml', 'lyrics')]),
                             ui.UiMenuItem(name=_("&karaoke"), **self.__action_and_action_param[('music_bxml', 'karaoke')]),
                         ])
        ...
        return ui.UiMenuBar(
            ...
            menu_item_list=[
                ui.UiMenuBar(
                    name=_("&clock"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&time"), **self.__action_and_action_param[('stm32', 'time')]),
                        ui.UiMenuItem(name=_("&date"), **self.__action_and_action_param[('stm32', 'date')]),
                        ui.UiMenuItem(name=_("&auto sync"), **self.__action_and_action_param[('system', 'auto_sync_date')]),
                    ]),

                ui.UiMenuBar(
                    name=_("&vocalize"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&volume"), **self.__action_and_action_param[('speech', 'volume')]),
                        ui.UiMenuItem(name=_("&speed"), **self.__action_and_action_param[('speech', 'speed')]),
                        ui.UiMenuItem(name=_("&language"), **self.__action_and_action_param[('speech', 'language')]),
                        ui.UiMenuItem(name=_("s&ynthesis"), **self.__action_and_action_param[('speech', 'synthesis')]),
                        ui.UiMenuItem(name=_("voi&ce"), **self.__action_and_action_param[('speech', 'voice')]),
                    ]),

                ui.UiMenuBar(
                    name=_("&usb"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("usb-&a-hid keyboard"), **self.__action_and_action_param[('stm32', 'usb_a_hid_keyboard')]),
                        ui.UiMenuItem(name=_("usb-&b-hid keyboard"), **self.__action_and_action_param[('stm32', 'usb_b_hid_keyboard')]),
                        ui.UiMenuItem(name=_("simulation &esys"), **self.__action_and_action_param[('stm32', 'usb_simul_esys')]),
                    ]),
                ui.UiMenuBar(
                    name=_("&bluetooth"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&power"), **self.__action_and_action_param[('bluetooth', 'power')]),
                        ui.UiMenuItem(name=_("&name"), **self.__action_and_action_param[('bluetooth', 'bnote_name')]),
                        ui.UiMenuItem(name=_("&visibility"), **self.__action_and_action_param[('bluetooth', 'bnote_visible')]),
                        ui.UiMenuItem(name=_("&paired devices"), **self.__action_and_action_param[('bluetooth', 'paired_devices')]),
                        ui.UiMenuItem(name=_("simulation &esys"), **self.__action_and_action_param[('bluetooth', 'bt_simul_esys')]),
                    ]),
                ui.UiMenuBar(
                    name=_("&wifi"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&power"), **self.__action_and_action_param[('wifi', 'power')]),
                        ui.UiMenuItem(name=_("&favorites"), **self.__action_and_action_param[('wifi', 'favorites')]),
                        ui.UiMenuItem(name=_("countr&y"), **self.__action_and_action_param[('wlan', 'country')]),
                    ]),
                ui.UiMenuBar(
                    name=_("user &interface"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&message language"), **self.__action_and_action_param[('stm32', 'language_message')]),
                        ui.UiMenuItem(name=_("&braille language"), **self.__action_and_action_param[('stm32', 'language_keyboard')]),
                        ui.UiMenuItem(name=_("braille &type"), **self.__action_and_action_param[('system', 'braille_type')]),
                        ui.UiMenuItem(name=_("spaces in &label"), **self.__action_and_action_param[('system', 'spaces_in_label')]),
                        ui.UiMenuItem(name=_("visible &shortcuts"), **self.__action_and_action_param[('system', 'shortcuts_visible')]),
                        ui.UiMenuItem(name=_("&developer mode"), **self.__action_and_action_param[('system', 'developer')]),
                        ui.UiMenuItem(name=_("&import settings"), action=self._exec_import_settings),
                        ui.UiMenuItem(name=_("&export settings"), action=self._exec_export_settings)
                    ]),

                ui.UiMenuBar(
                    name=_("main me&nu"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&explorer"), **self.__action_and_action_param[('system', 'app_explorer')]),
                        ui.UiMenuItem(name=_("&settings"), **self.__action_and_action_param[('system', 'app_settings')]),
                        ui.UiMenuItem(name=_("a&genda"), **self.__action_and_action_param[('system', 'app_agenda')]),
                        ui.UiMenuItem(name=_("&radio"), **self.__action_and_action_param[('system', 'app_radio')]),
                        ui.UiMenuItem(name=_("&audio"), **self.__action_and_action_param[('system', 'app_mp3')]),
                        ui.UiMenuItem(name=_("wi&kipedia"), **self.__action_and_action_param[('system', 'app_wikipedia')]),
                        ui.UiMenuItem(name=_("&timer"), **self.__action_and_action_param[('system', 'app_timer')]),
                        ui.UiMenuItem(name=_("trans&lator"), **self.__action_and_action_param[('system', 'app_translator')]),
                        ui.UiMenuItem(name=_("write &word"),
                                   **self.__action_and_action_param[('system', 'app_write_word')]),
                        ui.UiMenuItem(name=_("&operation"), **self.__action_and_action_param[('system', 'app_operation')]),
                        ui.UiMenuItem(name=_("&mines"), **self.__action_and_action_param[('system', 'app_mines')]),
                        ui.UiMenuItem(name=_("ma&stermind"),
                                   **self.__action_and_action_param[('system', 'app_mastermind')]),
                    ]),

                ui.UiMenuBar(
                    name=_("e&xplorer"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("empty the &bluetooth folder once shutdown"), **self.__action_and_action_param[('explorer', 'empty_bluetooth_shutdown')]),
                        ui.UiMenuItem(name=_("empty the &trash folder once shutdown"), **self.__action_and_action_param[('explorer', 'empty_trash_shutdown')]),
                        ui.UiMenuItem(name=_("&number of recent files"), **self.__action_and_action_param[('explorer', 'number_recent_files')]),
                    ]),

                ui.UiMenuBar(
                    name=_("&editor"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&braille type"), **self.__action_and_action_param[('editor', 'braille_type')]),
                        ui.UiMenuItem(name=_("&line length"), **self.__action_and_action_param[('editor', 'line_length')]),
                        ui.UiMenuItem(name=_("&forward display"), **self.__action_and_action_param[('editor', 'forward_display_mode')]),
                        ui.UiMenuItem(name=_("&autoscroll display"), **self.__action_and_action_param[('editor', 'autoscroll')]),
                        ui.UiMenuItem(name=_("&cursor visible"), **self.__action_and_action_param[('editor', 'cursor_visible')]),
                        ui.UiMenuItem(name=_("&dot78 visible"), **self.__action_and_action_param[('editor', 'dot78_visible')]),
                    ]),

                ui.UiMenuBar(
                    name=_("mat&h"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&format"), **self.__action_and_action_param[('math', 'format')]),
                        ui.UiMenuItem(name=_("&precision"), **self.__action_and_action_param[('math', 'precision')]),
                        ui.UiMenuItem(name=_("f&raction"), **self.__action_and_action_param[('math', 'fraction')]),
                        ui.UiMenuItem(name=_("&angle"), **self.__action_and_action_param[('math', 'angle')]),
                    ]),
                ...
                ui.UiMenuBar(
                    name=_("a&genda"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("default &presentation"), **self.__action_and_action_param[('agenda', 'default_presentation')]),
                        ui.UiMenuItem(name=_("&report events not done"), **self.__action_and_action_param[('agenda','remember')])
                    ]
                ),
                ...
                ui.UiMenuBar(
                    ...
                    menu_item_list=[
                        ui.UiMenuItem(name=_("use the &vocalize"), **self.__action_and_action_param[('braille_learning','use_vocal')]),
                        ui.UiMenuItem(name=_("&keep the spaces"), **self.__action_and_action_param[('braille_learning','keep_spaces')]),
                        ui.UiMenuItem(name=_("&allow all characters"), **self.__action_and_action_param[('braille_learning','write_all')])
                    ]
                ),
                ...
                ui.UiMenuBar(
                    name=_("&keyboard"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&mode"), **self.__action_and_action_param[('stm32', 'keyboard_mode')]),
                        ui.UiMenuItem(name=_("b78"), **self.__action_and_action_param[('stm32', 'keyboard_b78')]),
                        ui.UiMenuItem(name=_("&invertion"), **self.__action_and_action_param[('stm32', 'keyboard_invertion')]),
                        ui.UiMenuItem(name=_("&light press"), **self.__action_and_action_param[('stm32', 'keyboard_light_press')]),
                        ui.UiMenuItem(name=_("&strong press"), **self.__action_and_action_param[('stm32', 'keyboard_strong_press')]),
                        ui.UiMenuItem(name=_("&consecutive press"), **self.__action_and_action_param[('stm32', 'keyboard_consecutive_press')]),
                        ui.UiMenuItem(name=_("&double light press"), **self.__action_and_action_param[('stm32', 'keyboard_double_light_press')]),
                        ui.UiMenuItem(name=_("double st&rong press"), **self.__action_and_action_param[('stm32', 'keyboard_double_strong_press')]),
                    ]),

                ui.UiMenuBar(
                    name=_("&standby"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&transport"), **self.__action_and_action_param[('stm32', 'standby_transport')]),
                        ui.UiMenuItem(name=_("&shutdown"), **self.__action_and_action_param[('stm32', 'standby_shutdown')]),
                    ]),
    ...
    def __append_line_in_document(self, param_label=None, param_value=None, dialog_box_name=None,
                                  ...
                                  auto_refresh_on_timer=None, is_tab_stop=False):
        if section and key:
    ...
    def __update_document_line(self, index):
        ...
        if line['auto_refresh_on_timer'] == 'time':
            line['data_line_text'] = self.format_label_value(_("time"), self.__get_time_value())
        elif line['auto_refresh_on_timer'] == 'date':
            line['data_line_text'] = self.format_label_value(_("date"), self.__get_date_value())
        elif line['auto_refresh_on_timer'] == 'battery':
            line['data_line_text'] = self.format_label_value(_("battery"), self.__get_battery_value())
        elif line['auto_refresh_on_timer'] == 'volume':
            line['data_line_text'] = self.format_label_value(_("volume"), self.__get_volume_value())
        elif line['auto_refresh_on_timer'] == 'speech_language':
            line['data_line_text'] = self.format_label_value(_("language"), self.__get_speech_language_value())
        elif line['auto_refresh_on_timer'] == 'jack':
            line['data_line_text'] = self.format_label_value(_("jack"), self.__get_jack_value())
        elif line['auto_refresh_on_timer'] == 'usb_a_hid_keyboard':
            line['data_line_text'] = self.format_label_value(_("keyboard USB-A-HID"), self.__get_stm32_value('stm32', 'usb_a_hid_keyboard'))
        elif line['auto_refresh_on_timer'] == 'usb_b_hid_keyboard':
            line['data_line_text'] = self.format_label_value(_("keyboard USB-B-HID"), self.__get_stm32_value('stm32', 'usb_b_hid_keyboard'))
        elif line['auto_refresh_on_timer'] == 'paired_devices':
            self.__update_computers_and_paired_devices()
            line['data_line_text'] = self.format_label_value(_("paired devices"), self.__get_bluetooth_pairing_value())
        elif line['auto_refresh_on_timer'] == 'connected_to':
            line['data_line_text'] = self.format_label_value(_("connected to"), self.__get_wifi_connected_to())
        elif line['auto_refresh_on_timer'] == 'language_message':
            line['data_line_text'] = self.format_label_value(_("message language"), self.__get_message_language_country_value())
        elif line['auto_refresh_on_timer'] == 'language_keyboard':
            line['data_line_text'] = self.format_label_value(_("braille language"), self.__get_keyboard_language_country_value())
        elif line['auto_refresh_on_timer'] == 'standby_transport':
            line['data_line_text'] = self.format_label_value(_("transport timeout minute (0 none)"), self.__get_stm32_value('stm32', 'standby_transport'))
        elif line['auto_refresh_on_timer'] == 'standby_shutdown':
            line['data_line_text'] = self.format_label_value(_("shutdown timeout minute (0 none)"), self.__get_stm32_value('stm32', 'standby_shutdown'))
    ...
    def __update_document(self, update_computers_and_paired_device=False):
        ...
        self.__document_area = []
        self.__append_line_in_document(param_label=_("time"), param_value=self.__get_time_value(), dialog_box_name=_("time"), dialog_box_param_name=_("time"), section='stm32', key='time', auto_refresh_on_timer='time', is_tab_stop=True)
        self.__append_line_in_document(param_label=_("date"), param_value=self.__get_date_value(), dialog_box_name=_("date"), dialog_box_param_name=_("date"), section='stm32', key='date', auto_refresh_on_timer='date',)
        self.__append_line_in_document(param_label=_("auto sync date"), param_value=self.__get_settings_value('system', 'auto_sync_date'), dialog_box_name=_("clock"), dialog_box_param_name=_("auto &sync date"), section='system', key='auto_sync_date')

        self.__append_line_in_document()
        self.__append_line_in_document(param_label=_("battery"), param_value=self.__get_battery_value(), auto_refresh_on_timer='battery', is_tab_stop=True)

        self.__append_line_in_document()
        self.__append_line_in_document(param_label=_("synthesis"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("volume"), param_value=self.__get_volume_value(), dialog_box_name=_("volume"), dialog_box_param_name=_("&value"), section='speech', key='volume', auto_refresh_on_timer='volume')
        ...
        self.__append_line_in_document(param_label=_("language"), param_value=self.__get_speech_language_value(), dialog_box_name=_("language"), dialog_box_param_name=_("language"), section='speech', key='language', auto_refresh_on_timer='speech_language')
        ...
        if Gpio().gpio_hardware_v2():
            ...
            self.__append_line_in_document(param_label=_("jack"), param_value=self.__get_jack_value(), auto_refresh_on_timer='jack')

        self.__append_line_in_document()
        self.__append_line_in_document(param_label=_("usb"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("keyboard USB-A-HID"), param_value=self.__get_stm32_value('stm32', 'usb_a_hid_keyboard'), dialog_box_name=_("keyboard"), dialog_box_param_name=_("usb-a hid mode"), section='stm32', key='usb_a_hid_keyboard', auto_refresh_on_timer='usb_a_hid_keyboard')
        self.__append_line_in_document(param_label=_("keyboard USB-B-HID"), param_value=self.__get_stm32_value('stm32', 'usb_b_hid_keyboard'), dialog_box_name=_("keyboard"), dialog_box_param_name=_("usb-b hid mode"), section='stm32', key='usb_b_hid_keyboard', auto_refresh_on_timer='usb_b_hid_keyboard')
        ...
        self.__append_line_in_document(param_label=_("power"), param_value=self.__get_bluetooth_power(), dialog_box_name=_("bluetooth power"), dialog_box_param_name=_("&powered"), section='bluetooth', key='power')
        ...
        self.__append_line_in_document(param_label=_("paired devices"), param_value=self.__get_bluetooth_pairing_value(), dialog_box_name=_('bluetooth'), dialog_box_param_name=_("&paired devices"), section='bluetooth', key="paired_devices", auto_refresh_on_timer='paired_devices')
        ...
        self.__append_line_in_document(param_label=_("power"), param_value=self.__get_wifi_power(), dialog_box_name=_("wifi power"), dialog_box_param_name=_("&powered"), section='wifi', key='power')
        self.__append_line_in_document(param_label=_("connected to"), param_value=self.__get_wifi_connected_to(), dialog_box_name=_("connected to"), dialog_box_param_name=_("&connected"), section='wifi', key='connected_to', auto_refresh_on_timer='connected_to')
        self.__append_line_in_document(param_label=_("favorites"), param_value=self.__get_wifi_favorites_str(), dialog_box_name=_("favorites"), dialog_box_param_name=_("&favorites"), section='wifi', key='favorites')
        ...
        self.__append_line_in_document(param_label=_("message language"), param_value=self.__get_message_language_country_value(), dialog_box_name=_("language"), dialog_box_param_name=_("message"), section='stm32', key='language_message', auto_refresh_on_timer='language_message')
        self.__append_line_in_document(param_label=_("braille language"), param_value=self.__get_keyboard_language_country_value(), dialog_box_name=_("language"), dialog_box_param_name=_("braille"), section='stm32', key='language_keyboard', auto_refresh_on_timer='language_keyboard')
        ...
        self.__append_line_in_document(param_label=_("spaces in label"), param_value=self.__get_settings_value('system', 'spaces_in_label'), dialog_box_name=_("user interface"), dialog_box_param_name=_("spaces in &label"), section='system', key='spaces_in_label')
        ...
        self.__append_line_in_document(param_label=_("developer mode"), param_value=self.__get_settings_value('system', 'developer'), dialog_box_name=_("user interface"), dialog_box_param_name=_("&developer mode"), section='system', key='developer')

        self.__append_line_in_document()
        self.__append_line_in_document(param_label=_("main menu"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("explorer"),
                                       param_value=self.__get_settings_value('system', 'app_explorer'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("&explorer"),
                                       section='system', key='app_explorer')
        self.__append_line_in_document(param_label=_("settings"),
                                       param_value=self.__get_settings_value('system', 'app_settings'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("&settings"),
                                       section='system', key='app_settings')
        self.__append_line_in_document(param_label=_("agenda"),
                                       param_value=self.__get_settings_value('system', 'app_agenda'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("a&genda"),
                                       section='system', key='app_agenda')
        self.__append_line_in_document(param_label=_("radio"),
                                       param_value=self.__get_settings_value('system', 'app_radio'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("&radio"),
                                       section='system', key='app_radio')
        self.__append_line_in_document(param_label=_("audio"),
                                       param_value=self.__get_settings_value('system', 'app_mp3'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("&audio"),
                                       section='system', key='app_mp3')
        self.__append_line_in_document(param_label=_("wikipedia"),
                                       param_value=self.__get_settings_value('system', 'app_wikipedia'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("wi&kipedia"),
                                       section='system', key='app_wikipedia')
        self.__append_line_in_document(param_label=_("timer"),
                                       param_value=self.__get_settings_value('system', 'app_timer'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("&timer"),
                                       section='system', key='app_timer')
        self.__append_line_in_document(param_label=_("translator"),
                                       param_value=self.__get_settings_value('system', 'app_translator'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("trans&lator"),
                                       section='system', key='app_translator')
        self.__append_line_in_document(param_label=_("write_word"),
                                       param_value=self.__get_settings_value('system', 'app_write_word'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("&write word"),
                                       section='system', key='app_write_word')
        self.__append_line_in_document(param_label=_("operation"),
                                       param_value=self.__get_settings_value('system', 'app_operation'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("&operation"),
                                       section='system', key='app_operation')
        self.__append_line_in_document(param_label=_("mines"),
                                       param_value=self.__get_settings_value('system', 'app_mines'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("&mines"),
                                       section='system', key='app_mines')
        self.__append_line_in_document(param_label=_("mastermind"),
                                       param_value=self.__get_settings_value('system', 'app_mastermind'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("ma&stermind"),
                                       section='system', key='app_mastermind')

        self.__append_line_in_document()
        self.__append_line_in_document(param_label=_("explorer"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("empty the bluetooth folder once shutdown"), param_value=self.__get_settings_value('explorer', 'empty_bluetooth_shutdown'), dialog_box_name=_('explorer'), dialog_box_param_name=_("&empty the bluetooth once shutdown"), section='explorer', key='empty_bluetooth_shutdown')
        self.__append_line_in_document(param_label=_("empty the trash folder once shutdown"), param_value=self.__get_settings_value('explorer', 'empty_trash_shutdown'), dialog_box_name=_('explorer'), dialog_box_param_name=_("&empty the trash once shutdown"), section='explorer', key='empty_trash_shutdown')
        self.__append_line_in_document(param_label=_("number of recent files"), param_value=self.__get_settings_value('explorer', 'number_recent_files'), dialog_box_name=_('explorer'), dialog_box_param_name=_("files &number"), section='explorer', key='number_recent_files')
        ...
        self.__append_line_in_document(param_label=_("autoscroll display"), param_value="{}s".format(self.__get_settings_value('editor', 'autoscroll')), dialog_box_name=_('editor'), dialog_box_param_name=_("&autoscroll display"), section='editor', key='autoscroll')
        ...
        self.__append_line_in_document(param_label=_("musicxml braille type"), param_value=self.__get_settings_value('music_xml', 'braille_type'), dialog_box_name=_("music xml"), dialog_box_param_name=_("braille &type"), section='music_xml', key='braille_type')
        ...
        self.__append_line_in_document(param_label=_("bxml braille type"), param_value=self.__get_settings_value('music_bxml', 'braille_type'), dialog_box_name=_("music bxml"), dialog_box_param_name=_("braille &type"), section='music_bxml', key='braille_type')
        ...
        self.__append_line_in_document(param_label=_("at startup, report events not done"), param_value=self.__get_settings_value('agenda', 'remember'), dialog_box_name=_("agenda"), dialog_box_param_name=_("report events"), section='agenda', key='remember')

        self.__append_line_in_document()
        self.__append_line_in_document(_("write word and operation"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("use the vocal synthesis"), param_value=self.__get_settings_value('braille_learning', 'use_vocal'), dialog_box_name=_("braille learning"), dialog_box_param_name=_("&vocal"), section='braille_learning', key='use_vocal')
        self.__append_line_in_document(param_label=_("keeping spaces"), param_value=self.__get_settings_value('braille_learning', 'keep_spaces'), dialog_box_name=_("braille learning"), dialog_box_param_name=_("&spaces"), section='braille_learning', key='keep_spaces')
        self.__append_line_in_document(param_label=_("allow the wrong hit"), param_value=self.__get_settings_value('braille_learning', 'write_all'), dialog_box_name=_("braille learning"), dialog_box_param_name=_("&allow all"), section='braille_learning', key="write_all")
        ...
        self.__append_line_in_document(param_label=_("transport timeout minute (0 none)"), param_value=self.__get_stm32_value('stm32', 'standby_transport'), dialog_box_name=_("standby"), dialog_box_param_name=_("transport"), section='stm32', key='standby_transport', auto_refresh_on_timer='standby_transport')
        self.__append_line_in_document(param_label=_("shutdown timeout minute (0 none)"), param_value=self.__get_stm32_value('stm32', 'standby_shutdown'), dialog_box_name=_("standby"), dialog_box_param_name=_("shutdown"), section='stm32', key='standby_shutdown', auto_refresh_on_timer='standby_shutdown')
        ...
        # b.note version
        self.__append_line_in_document(param_label=_("applications"), param_value=version.__version__, dialog_box_name=_("application versions"), dialog_box_param_name=_("version"), section='version', key='application')
        # Firmware version
    ...
    def on_timer(self):
        if (self.__test_mode == TestMode.NO_TEST) and not self._in_menu and self._current_dialog is None and \
                self.__document_area[self.__document_area_current_line_index]['auto_refresh_on_timer'] is not None:
    ...
    def __translation_settings_dict(self, in_braille=True):
        translated_dict = {
            ...
            ('music_xml', 'edit_mode'): {'expert': _("expert"), 'read': _("read"), 'edit': _("edit"), 'listen': _("listen")},
            ('music_xml', 'braille_type'): {'dot-8': _("dot 8"), 'grade1': _("grade 1")},
            ('music_xml', 'notes_dots'): {"8_dots": _("8 dots"), "6_dots": _("6 dots"), "6_dots_with_group": _("6 dots with group")},
            ('music_xml', 'parts'): {"name": _("name"), "abbreviation": _("abbreviation")},
            ...
            ('music_bxml', 'edit_mode'): {'expert': _("expert"), 'read': _("read"), 'edit': _("edit"), 'listen': _("listen")},
            ('music_bxml', 'braille_type'): {'dot-8': _("dot 8"), 'grade1': _("grade 1")},
            ('music_bxml', 'notes_dots'): {"8_dots": _("8 dots"), "6_dots": _("6 dots"), "6_dots_with_group": _("6 dots with group")},
            ('music_bxml', 'parts'): {"name": _("name"), "abbreviation": _("abbreviation")},
            ...
            ('system', 'app_explorer'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"), 'more_apps_menu': _("in more apps menu")},
            ('system', 'app_settings'): {'main_apps_menu': _("in main apps menu"), 'more_apps_menu': _("in more apps menu")},
            ('system', 'app_agenda'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"), 'more_apps_menu': _("in more apps menu")},
            ('system', 'app_radio'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"), 'more_apps_menu': _("in more apps menu")},
            ('system', 'app_mp3'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"), 'more_apps_menu': _("in more apps menu")},
            ('system', 'app_wikipedia'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"), 'more_apps_menu': _("in more apps menu")},
            ('system', 'app_timer'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"), 'more_apps_menu': _("in more apps menu")},
            ('system', 'app_translator'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"), 'more_apps_menu': _("in more apps menu")},
            ('system', 'app_write_word'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"), 'more_apps_menu': _("in more apps menu")},
            ('system', 'app_operation'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"), 'more_apps_menu': _("in more apps menu")},
            ('system', 'app_mines'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"), 'more_apps_menu': _("in more apps menu")},
            ('system', 'app_mastermind'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"), 'more_apps_menu': _("in more apps menu")},
    ...
    def __ui_bool_values_dict():
        return {True: ui.UiCheckBox("fake", ("id", True)).get_str_value()[1],
    ...
    def __dialog_set_settings(self, section, key, **kwargs):
        ...
        for line in self.__document_area:
            ...
            if section == line['section'] and key == line['key']:
                ...
                self._current_dialog = ui.UiSettingsDialogBox(line["dialog_box_name"], line["dialog_box_param_name"],
    ...
    def __dialog_set_wlan_country(self, section, key, **kwargs):
        country_string, countries_dict = SettingsApp.__get_wlan_countries_and_country()
        self._current_dialog = ui.UiSettingsDialogBox("wlan country", "wlan country",
    ...
    def __dialog_show_paired_devices(self, section, key, **kwargs):
        if bt_util.bluetooth_on_off():
            ...
            self._current_dialog = ui.UiDialogBox(
                ...
                item_list=[
                    ui.UiListBox(name=self.__document_area[self.__document_area_current_line_index]["dialog_box_param_name"],
                              value=("host", self.__computers)
                              ),
                    ui.UiButton(name=_("&ok"), action=self.__exec_bluetooth_paired_device_cancel_dialog),
                    ui.UiButton(name=_("&remove"), action=self.__remove_bluetooth_paired_device)
                ],
                action_cancelable=self.__exec_bluetooth_paired_device_cancel_dialog,
            )
        else:
            # Warning if bluetooth not powered.
            self._current_dialog = ui.UiInfoDialogBox(message=_("bluetooth adapter is not powered"), action=self._exec_cancel_dialog)
    ...
    def dialog_restart(self):
            self._current_dialog = ui.UiMessageDialogBox(
                ...
                buttons=[
                    ui.UiButton(name=_("&ok"), action=self.__exec_restart_now)],
    ...
    def __exec_wifi_power(self, on):
        if WifiNmcliCommand.network_on_off(on):
            ...
            self._current_dialog = ui.UiInfoDialogBox(
                message=_("command failed"), action=self._exec_cancel_dialog,
            )
        ...
        if WifiNmcliCommand.network_on_off():
            ...
            self._current_dialog = ui.UiDialogBox(
                ...
                item_list=[
                    ...
                    ui.UiButton(name=_("&ok"), action=self._exec_valid_set_wifi_favorites_dialog),
                    ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
                    ui.UiButton(name=_("&set first"), action=self._exec_first_wifi_favorites_dialog),
                    ui.UiButton(name=_("&remove"), action=self._exec_remove_wifi_favorites_dialog),
                    ui.UiButton(name=_("&add"), action=self._exec_add_wifi_favorites_dialog)
                ],
                action_cancelable=self._exec_cancel_dialog,
            ...
            self._current_dialog = ui.UiInfoDialogBox(message=_("wifi adapter is not powered"), action=self._exec_cancel_dialog)
    ...
    def _exec_first_wifi_favorites_dialog(self):
        ...
        if WifiNmcliCommand.network_up(favorites[index]['ssid']):
            ...
            self._current_dialog = ui.UiInfoDialogBox(
                message=_("command failed"), action=self._exec_cancel_dialog, extra_parameters=(index, favorites)
            )
    ...
    def _exec_remove_wifi_favorites_dialog(self):
        ...
        if WifiNmcliCommand.network_remove(favorites[index]['ssid']):
            ...
            # Failed to delete access point.
            self._current_dialog = ui.UiInfoDialogBox(
                message=_("deletion failed"), action=self._exec_cancel_dialog, extra_parameters=(index, favorites)
            )
    ...
    def _exec_add_wifi_favorites_dialog(self, **kwargs):
        ...
        self._current_dialog = ui.UiDialogBox(
            name=self.__document_area[self.__document_area_current_line_index]["dialog_box_name"],
            item_list=[
                ui.UiButton(name=_("&scan"), action=self._exec_scan_add_wifi_favorites_dialog),
                ui.UiEditBox(name=_("ssid"),
                          value=('ssid', ssid)
                          ),
                ui.UiEditBox(name=_("password"),
                          value=('password', "")
                          ),
                ui.UiButton(name=_("&add"), action=self._exec_valid_add_wifi_favorites_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_add_wifi_favorites_dialog),
            ],
    ...
    def _end_scan_wifi(self, **kwargs):
        ...
        self._current_dialog = ui.UiDialogBox(
            ...
            item_list=[
                ...
                ui.UiButton(name=_("&ok"), action=self._exec_valid_scan_wifi_favorites_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_scan_wifi_favorites_dialog),
            ],
    ...
    def _exec_valid_add_wifi_favorites_dialog(self):
        ...
        if ssid and (len(ssid) > 0):
            ...
            if WifiNmcliCommand.network_add(ssid, password):
                ...
                # Refresh the dialog box
                self.__dialog_set_wifi_favorites_settings(section='wifi', key='favorites', **kwargs)
                return
        # Failed to delete access point.
        self._current_dialog = ui.UiInfoDialogBox(
            message=_("add failed"), action=self._exec_cancel_dialog, extra_parameters=(kwargs['index'], kwargs['favorites'])
        )
    ...
    def __dialog_set_time(self, section, key, **kwargs):
        ...
        self._current_dialog = ui.UiDialogBox(
            name=self.__document_area[self.__document_area_current_line_index]["dialog_box_name"],
            item_list=[
                ui.UiEditBox(name=_("hours"),
                          value=("hour", hour)
                          ),
                ui.UiEditBox(name=_("minutes"),
                          value=("minute", self.braille_form(True, str(minute)))
                          ),
                ui.UiEditBox(name=_("seconds"),
    ...
    def __dialog_set_date(self, section, key, **kwargs):
        ...
        self._current_dialog = ui.UiDialogBox(
            name=self.__document_area[self.__document_area_current_line_index]["dialog_box_name"],
            item_list=[
                ui.UiEditBox(name=_("day"),
                          value=("day", day)
                          ),
                ui.UiEditBox(name=_("month"),
                          value=("month", self.braille_form(True, str(month)))
                          ),
                ui.UiEditBox(name=_("year"),
    ...
    def refresh_install_message(self, msg):
        ...
        self._put_in_function_queue(FunctionId.ASK_TO_REFRESH_MESSAGE_DIALOG, **{'msg': msg})
    ...
    def _exec_about_bnote(self):
        bnote_list=[
            ...
            _("serial number: {}").format(braille_device_characteristics.get_serial_number()),
            _("subtype: {}").format(self.__device_sub_type(False)[braille_device_characteristics.get_sub_type()]),
            _("line length: {}").format(braille_device_characteristics.get_braille_display_length()),
        ]
        if braille_device_characteristics.is_esysuite_option():
            bnote_list.append(_("option: esysuite"))
        bnote_list+=[
            _("applications: {}").format(version.__version__),
            _("firmware: {}").format(braille_device_characteristics.get_firmware_version()),
            _("sdcard: {}").format(self.__sdcard_version[:-1])
        ]
        document_eurobraille=_("{}\n{}\nPhone: {}\nEmail: {}\nWebsite: {}").format("Eurobraille", "31 Cours des Juilliottes - 94700 MAISONS-ALFORT","(+33)1 55 26 91 00","contact@eurobraille.fr","www.eurobraille.fr")
        document_bnote=""
        for i in bnote_list:
            document_bnote+="{}\n".format(i)
        self._current_dialog=ui.UiDialogBox(
            name=_("about"),
            item_list=[
                ui.UiMultiLinesBox(name="bnote", value=("bnote", document_bnote[:-1]), is_read_only=True),
                ui.UiMultiLinesBox(name="eurobraille", value=("eurobraille", document_eurobraille), is_read_only=True),
    ...
    def _exec_settings_ok_dialog(self, new_value):
        ...
        if (((section == 'system') and (key == 'shortcuts_visible'))
                or ((section == 'system') and (key == 'spaces_in_label'))):
            # Alert internal about settings change.
            self._put_in_function_queue(FunctionId.FUNCTION_SETTINGS_CHANGE, **{'section': section, 'key': key})
    ...
    def __dialog_application_version(self, section, key, **kwargs):
        ...
        self._current_dialog = ui.UiDialogBox(
            ...
            item_list=[
                ui.UiListBox(name=_("version"),
                             value=('version', list(versions.keys())),
                             current_index=0,
                             extra_parameters=list(versions.values())),
                ui.UiButton(name=_("&switch to"), action=self._exec_application_version_switch_to),
                ui.UiButton(name=_("&delete"), action=self._exec_application_version_delete),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_application_version_switch_to(self):
        ...
        if YAUpdater.update_config_file(folder):
            self._current_dialog = ui.UiInfoDialogBox(message=_("install done, restart new version..."))
            self._put_in_function_queue(FunctionId.ASK_TERMINATE_BNOTE_AND_RESTART_SERVICE)
            # self.yaupdater_restart_new_version()
    ...
    def _exec_valid_export(self, force=False):
        kwargs = self._current_dialog.get_values()
        file_name = "{}/{}".format(str(FileManager.get_settings_path()), kwargs['file_name'])
        if not force:
            # Check if file already exist
            if os.path.exists(file_name):
                self._current_dialog = ui.UiMessageDialogBox(
                    name=_("warning"),
                    message=_("the settings file already exists. Do you want to replace it?"),
                    buttons=[
                        ui.UiButton(name=_("&yes"), action=self._exec_valid_export,
    ...
    def _exec_import_settings(self):
        ...
        self._current_dialog = ui.UiDialogBox(
            ...
            item_list=[
                ui.UiListBox(name=_("setting"), value=('files', files_list), current_index=0, extra_parameters=paths_list),
                ui.UiButton(name=_("&import"), action=self._exec_valid_import_settings),
                ui.UiButton(name=_("&delete"), action=self._exec_delete_import_settings),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
